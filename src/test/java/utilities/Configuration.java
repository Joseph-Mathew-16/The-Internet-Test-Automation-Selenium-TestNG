...
public class Configuration {
    ...
    public static Duration timeoutsDurationsImplicitWait;
    public static Duration timeoutsDurationsPageLoadTimeout;
    public static Duration timeoutsDurationsExplicitWait;
    public static boolean browserBrowserExecutionChrome;
    public static boolean browserBrowserExecutionFirefox;
    public static boolean browserBrowserExecutionEdge;
    public static boolean browserBrowserExecutionSafari;
    public static boolean browserHeadlessMode;
    public static int browserWindowSizeWidth;
    public static int browserWindowSizeHeight;
    public static int retryLogicMaxRetries;
    public static int reportLogLevel;
